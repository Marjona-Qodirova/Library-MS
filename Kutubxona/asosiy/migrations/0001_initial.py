    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('janr', models.CharField(choices=[('Badiiy', 'Badiiy'), ('Ilmiy', 'Ilmiy'), ('Hujjatli', 'Hujjatli'), ('Detektiv', 'Detektiv')], max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Muallif',
            fields=[
                ...
                ('jins', models.CharField(choices=[('Man', 'Man'), ('Woman', 'Woman')], max_length=10)),
